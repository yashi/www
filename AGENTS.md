...
- Use Zola 0.22.0 or later. The README and CI workflows are the current source
  of truth; `doc/develop.md` contains an older version reference.
...
If `zola` is not on `PATH`, use an available Zola 0.22.0+ binary explicitly.
